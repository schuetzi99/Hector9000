...
class Database:
    ...
    def _import_Ingredients(self):
      if not self._check_Table_is_Filled("Ingredients"):
        ...
        self.cur.execute("""INSERT INTO "Ingredients" ("Code", "Name", "IsAlcoholic") VALUES ('sekt', 'Sekt', 1);""")
        ...
        self.cur.execute("""INSERT INTO "Ingredients" ("Code", "Name") VALUES ('apfels', 'Apfelsaft');""")
        ...
        self.cur.execute("""INSERT INTO "Ingredients" ("Code", "Name") VALUES ('curacaos', 'Curacao Sirup');""")
        ...
        self.cur.execute("""INSERT INTO "Ingredients" ("Code", "Name") VALUES ('zitronenlim', 'Zitronenlimonade');""")
        self.con.commit()
